...
function LandingVisual() {
  return (
    <div className="w-full h-full flex flex-col" style={{ background: "linear-gradient(135deg, #0a0e1a 0%, #0d1530 100%)" }}>
      <div className="flex items-center px-6 py-3 border-b" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
...
function SignUpVisual() {
  return (
    <div className="w-full h-full flex items-center justify-center" style={{ background: "linear-gradient(135deg, #0a0e1a 0%, #0d1530 100%)" }}>
      <div style={{ width: 380, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 16, padding: 32 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, padding: "10px 14px", color: "rgba(255,255,255,0.4)", fontSize: 13 }}>
            Full name
          </div>
          <div style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, padding: "10px 14px", color: "rgba(255,255,255,0.4)", fontSize: 13 }}>
            Email address
...
function ConnectRepoVisual() {
  return (
    <div className="w-full h-full flex flex-col" style={{ background: "#0a0e1a" }}>
      <div className="flex" style={{ flex: 1 }}>
        ...
        <div style={{ flex: 1, padding: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
            ...
            <div style={{ background: "#00f0ff", borderRadius: 8, padding: "8px 16px", fontWeight: 700, fontSize: 13, color: "#0a0e1a", display: "flex", alignItems: "center", gap: 6 }}>
              + Connect Repository
            </div>
          </div>
      ...
      <div className="flex" style={{ flex: 1 }}>
        ...
        <div style={{ flex: 1, padding: 24, overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <div style={{ flex: "0 0 140px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: 16, display: "flex", flexDirection: "column", alignItems: "center" }}>
              ...
              <svg width="80" height="80" viewBox="0 0 80 80">
                ...
                <circle cx="40" cy="40" r="32" fill="none" stroke="#00f0ff" strokeWidth="8"
                  strokeDasharray={`${2 * Math.PI * 32 * 0.73} ${2 * Math.PI * 32}`}
...
function DeployVisual() {
  return (
    <div className="w-full h-full flex flex-col" style={{ background: "#0a0e1a" }}>
      <div className="flex" style={{ flex: 1 }}>
        <div style={{ width: 200, borderRight: "1px solid rgba(255,255,255,0.06)", padding: "16px 0", background: "rgba(255,255,255,0.02)" }}>
          {["⊞ Dashboard", "⌥ Repositories", "◈ Services", "◎ Settings"].map((item, i) => (
            <div key={item} style={{
              display: "flex", alignItems: "center", gap: 10, padding: "9px 20px",
            ...
            {["Platform", "Config", "Deploy"].map((step, i) => (
              <div key={step} style={{ display: "flex", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 14px", borderRadius: 6,
                  ...
                  <div style={{ width: 20, height: 20, borderRadius: "50%", background: i <= 1 ? "#00f0ff" : "rgba(255,255,255,0.1)",
                    display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 700,
                    color: i <= 1 ? "#0a0e1a" : "rgba(255,255,255,0.3)" }}>{i + 1}</div>
...
function SuccessVisual() {
  return (
    <div className="w-full h-full flex items-center justify-center" style={{ background: "radial-gradient(ellipse at center, rgba(0,240,255,0.08) 0%, #0a0e1a 70%)" }}>
      <div style={{ textAlign: "center", maxWidth: 500 }}>
        <div style={{ fontSize: 64, marginBottom: 20 }}>🚀</div>
        <h2 style={{ fontSize: 36, fontWeight: 800, color: "white", letterSpacing: -1, marginBottom: 8 }}>
          Your App is Live!
        </h2>
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 15, marginBottom: 28 }}>
          my-ai-chatbot is deployed and serving traffic
        </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            lineHeight: 1.25, letterSpacing: -0.5, marginBottom: 10,
          }}>
            {step.title}
          </h2>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span>🔒</span>
                <span>cloudlift.app{current === 0 ? "" : current === 1 ? "/sign-up" : current === 2 ? "/repositories" : current === 3 ? "/repositories/analysis" : current === 4 ? "/launch" : "/dashboard"}</span>
              </div>
